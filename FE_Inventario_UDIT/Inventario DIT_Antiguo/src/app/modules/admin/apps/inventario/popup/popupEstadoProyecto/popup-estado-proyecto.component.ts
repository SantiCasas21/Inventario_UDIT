...
export class PopupEstadoProyectoComponent {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data:any, private ref:MatDialogRef<PopupEstadoProyectoComponent>, private formBuilder:FormBuilder, private service:CatalogoService) {
